(() => {
  function getMainClone() {
    ...
    // Optional: allow opting things out later
  ...
  function getCopyPayload() {
    ...
    // innerText preserves line breaks more like what a human expects.
  ...
  async function writeClipboard({ text, html }) {
    // Best experience: provide both HTML + plain text
